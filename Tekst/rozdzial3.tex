...
urz±dzeniami. Istniej± ró¿ne kryteria podzia³u interfejsów \cite{Krzyzanowski207}:
\begin{itemize}
...
Uzasadniaj± to fakt wykorzystania przez wiêkszo¶æ wspó³czesnych urz±dzeñ
...
(st±d nazwa), dziêki czemu nie s± konieczne bity startu i stopu. Dla
zapewnienia poprawno¶ci synchronizacji, sygna³ zegara przesy³any jest
dodatkow± lini±, dziêki czemu zarówno odbiornik jak i nadajnik przesy³aj±
bity w jednakowych odstêpach czasu. Dane przesy³ane grupowane s± w
bloki zwane ramkami (ang. \emph{frame}). Ka¿d± ramkê rozpoczyna nag³ówek
(rysunek \ref{fig:Ramka-transmisji-szeregowej-synchr}), zawieraj±cy
dodatkowe informacje, np. ilo¶æ przesy³anych danych. Blok danych zawiera
w³a¶ciwe dane zgrupowane jeden za drugim. W celu zapewnienia poprawno¶ci
transmisji, s± one zakoñczone tzw. bajtami kontrolnymi i ewentualnymi
bajtami korekcyjnymi pozwalaj±cymi na naprawê uszkodzonych danych
...
SPI mo¿e byæ scharakteryzowany jako:
\begin{itemize}
\item szeregowy,
\item synchroniczny,
...
nie jest to regu³±; istniej± uk³ady w których przesy³a siê 12, 16
lub 24 bity. Niektóre urz±dzenia \emph{slave} nie pozwalaj± na odbieranie
