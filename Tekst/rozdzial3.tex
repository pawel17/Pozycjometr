...
\caption{Uk³ad transmisji szeregowej (opis sygna³ów w tek¶cie) (\emph{¬ród³o:}
...
spoczynku przez tzw. czas martwy. Dane przesy³ane nosz± tak¿e nazwê
znaku i~zawieraj± zwykle od piêciu do o¶miu bitów. Aby odbiornik
...
zewnêtrznymi takimi jak przetworniki A/D oraz D/A, pamiêci EEPROM,
czujniki (akcelerometry, ¿yroskopy), pamiêci flash, sterowniki ekranów
dotykowych itp. W ¶wietle omówionych wcze¶niej cech interfejsów, SPI
mo¿e byæ scharakteryzowany jako:
\begin{itemize}
\item szeregowy,
\item synchroniczny,
...
wykorzystywaæ tylko jeden sygna³ CS. Schemat takiego po³±czenia przedstawiono
...
chain} (\emph{¬ród³o:} \cite{spi_daisy_chain})\label{fig:Komunikacja-przy-pomocy}}
...
mikrokontroler itp.),
\item konwertera szeregowo-równoleg³ego, umo¿liwiaj±cego odbiór danych przez
