...
Powodem wyboru tej technologii by³a wzglêdna prostota i mnogo¶æ klas
i technik, które umo¿liwia³y osi±gniêcie postawionego celu na systemie
Windows. 
...
\begin{figure}
\begin{centering}
\includegraphics[scale=0.7]{rys/aplikacja/info}\caption{Okno informacji o programie}
...
\begin{figure}
\begin{centering}
\includegraphics[scale=0.7]{rys/aplikacja/blad}\caption{Okno b³êdu}
