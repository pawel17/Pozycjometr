...
\documentclass[11pt,twoside,twocolumn,polish,pdflatex]{aghdpl}
...
\acknowledgements{Serdecznie dziêkujemy promotorowi za pomoc i nieocenione uwagi, które przyczyni³y siê do znacznej poprawy merytorycznej pracy.} 
...
\include{rozdzial4}\include{rozdzial6}\include{rozdzial7}
