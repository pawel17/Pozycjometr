...
breakpoint}) oraz punktów podgl±dowych (ang. \emph{watchpoint}) \cite{Paprocki2009}.
...
Rdzeñ \emph{Cortex-M3} jest w stanie zaadresowaæ przestrzeñ 4 GB pamiêci
\cite{LPC1768}, \cite{Paprocki2009}. Obejmuje ona tzw. segmenty,
m. in. pamiêæ programu, SRAM i zewnêtrzn± pamiêæ RAM. Odpowiedni±
mapê pamiêci pokazano na rysunku \ref{fig:Mapa-pamieci}.
...
Pozwala on na obs³ugê maksymalnie piêtnastu przerwañ (wyj±tków) systemowych
...
i wszystkie przerwania zewnêtrzne mog± mieæ ustalany programowo priorytet
