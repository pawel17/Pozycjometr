...
zastêpowane obecnie przez uk³ady serii \emph{Cortex}.
...
Najsilniejszym, pod wzglêdem mocy i mo¿liwo¶ci obliczeniowych, przedstawicielem
...
0x40000000 {[}\cite{LPC1768}{]}. Takie rozwi±zanie pozwala na optymaln±
pracê rdzenia. Normalnie aby zmieniæ jeden bit, nale¿y odczytaæ warto¶æ
...
Dziêki wykorzystaniu dostêpu bitowego, ten sam rezultat mo¿na uzyskaæ
...
dziêki poni¿szym formu³om \cite{bit_band_arm_www}:
...
Pozwala on na obs³ugê piêtnastu przerwañ (wyj±tków) systemowych i
...
i wszystkie przerwania wewnêtrzne mog± mieæ ustalany programowo priorytet
...
Mo¿liwo¶ci kontrolera \emph{NVIC} mo¿na skrótowo opisaæ w nastêpuj±cych
punktach\cite{Paprocki2009}:
\begin{enumerate}
